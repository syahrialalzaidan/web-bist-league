...
export default function Timeline() {
    return (
        <div className="relative bg-gradient-to-r from-[#279181] to-[#005E7C] pt-9 lg:py-14 pb-9 px-3.5 lg:px-40">
            <h1 className="text-4xl lg:text-5xl font-extrabold text-[#F3EEE7] mb-12">Timeline</h1>
                ...
                <div className="relative wrap lg:flex overflow-hidden h-full">
                    <div className="mb-5 flex lg:flex-col justify-between items-center w-full right-timeline">
                        <div className="order-1 w-5/12 py-4 mr-3.5 lg:mr-0 lg:w-full">
                            <h3 className="font-semibold text-white text-sm text-center">Aug 14 - Aug 20</h3>
                        </div>
                    ...
                    <div className="mb-5 flex lg:flex-col justify-between items-center w-full right-timeline">
                        <div className="order-1 w-5/12 py-4 mr-3.5 lg:mr-0 lg:w-full">
                            <h3 className="font-semibold text-white text-sm text-center">Aug 14 - Sep 3</h3>
                        </div>
                        <div className="z-20 flex items-center order-1 bg-[#F8A22D] shadow-xl w-7 h-7 rounded-full" />
                        <div className="order-1 w-5/12 py-4 pl-6 lg:pl-0 lg:w-3/4">
                    ...
                    <div className="mb-5 flex lg:flex-col justify-between items-center w-full right-timeline">
                        <div className="order-1 w-5/12 py-4 mr-3.5 lg:mr-0 lg:w-full">
                            <h3 className="font-semibold text-white text-sm text-center">Aug 21 - Sep 17</h3>
                        </div>
                        <div className="z-20 flex items-center order-1 bg-[#F8A22D] shadow-xl w-7 h-7 rounded-full" />
                        <div className="order-1 w-5/12 py-4 pl-6 lg:pl-0 lg:w-3/4">
